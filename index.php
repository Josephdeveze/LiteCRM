...
if (file_exists('/home/users/joseph/www')) {
    define('ROOT_PATH', '/home/users/joseph/www');
} else {
    define('ROOT_PATH', __DIR__);
}
define('BASE_URL', "");

// Vérification de l'existence de l'autoload
$autoloadPath = ROOT_PATH . '/vendor/autoload.php';
if (!file_exists($autoloadPath)) {
    die("Erreur : Le fichier autoload.php n'existe pas dans : " . $autoloadPath);
}
